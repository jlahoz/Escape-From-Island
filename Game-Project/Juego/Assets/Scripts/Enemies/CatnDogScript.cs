...
public class CatnDogScript : MonoBehaviour
{
    // Movimiento
    ...
    private void Move()
    {
        ...
        cc2D.size = new Vector2(2.868492f, 4.311576f);
    ...
    private void Attack()
    {
        cc2D.size = new Vector2(3.552755f, 3.552755f);  // Cambiar el Capsule Collider al cambiar animacion para que no flote.
        cc2D.offset = new Vector2(-0.7835389f, -0.5039618f);
        velocity = 3f;
