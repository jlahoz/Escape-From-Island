...
public class RedHatScript : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (direction.x >= 0.0f)
        {
            transform.localScale = new Vector3(0.3103891f, 0.3103891f, 0.3103891f);
        }
        else
        {
            transform.localScale = new Vector3(-0.3103891f, 0.3103891f, 0.3103891f);
    ...
    private void Move()
    {
        ...
        cc2D.size = new Vector2(2.459107f, 4.576222f);
        cc2D.offset = new Vector2(0.7327446f, 0.1431955f);
